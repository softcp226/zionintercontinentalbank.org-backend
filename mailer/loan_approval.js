...
<main>
  ...
  <div class="maincontainer">
    ...
    <p class="sm-p">
      ...
      congratulations your loan is approved and backed by investors
    </p>
    <p class="sm-p">your funds has been deposited into your account</p>
    <p class="sm-p">
      As we continue to work together, you can access your fund when next you
      log into your account. You can also access your loan documents and
      authorization in the loan documents.
    </p>
    <p class="sm-p">
      Note: if you did not request for a loan, it means someone else has access
      to your account. please contact your relation officer or customer support
